<%@ Page Title="" Language="C#" MasterPageFile="~/AI/LayoutEnterprise/MPEA.Master" AutoEventWireup="true"
    CodeBehind="IMServices.aspx.cs" Inherits="JEMEA.Master.IMServices" %>
            ...
            <div class="container-fluid">
                <div class="mp_ctrl_breadcrumb row clearfix">
                    <div class="breadcrumb-line">
                        <ul class="breadcrumb">
                            <li>Master</li>
                            <li class="active">Service Item Master</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row mp_ctrl_ph">
                    <div class="col-md-6">
                        <h2 class="mp_ctrl_frmheading">Service Item  Master</h2>
                    </div>
                    <div class="col-md-6">
