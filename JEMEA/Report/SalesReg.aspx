<%@ Page Title="" Language="C#" MasterPageFile="~/AI/LayoutEnterprise/MPEA.Master" AutoEventWireup="true"
    CodeBehind="SalesReg.aspx.cs" Inherits="JEMEA.Purchase.SalesReg" %>
            ...
            <div class="container-fluid">
                ...
                <asp:MultiView ID="MultiView1" runat="server">
                    ...
                    <asp:View ID="Entry" runat="server">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h2 class="mp_ctrl_gv_title">Sales Detail Report
                                 <span class="pull-right">
                        ...
                        <hr class="mp_ctrl_gv_hr" />
                        <div class="table-responsive">
                            <asp:GridView ID="gvdtl" runat="server" AllowPaging="true" PageSize="10" AutoGenerateColumns="False"    OnPageIndexChanging="gvdtl_PageIndexChanging"
