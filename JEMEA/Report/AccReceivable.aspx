<%@ Page Title="" Language="C#" MasterPageFile="~/AI/LayoutEnterprise/MPEA.Master" AutoEventWireup="true"
    CodeBehind="AccReceivable.aspx.cs" Inherits="JEMEA.Purchase.AccReceivable" %>
        ...
        <ContentTemplate>
            ...
            <div class="container-fluid">
                ...
                <div class="row mp_ctrl_ph">
                    <div class="col-md-6">
                        <h2 class="mp_ctrl_frmheading">Account Receivable</h2>
                    </div>
                    <div class="col-md-6">
                ...
                <asp:MultiView ID="MultiView1" runat="server">
                    <asp:View ID="List" runat="server">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h2 class="mp_ctrl_gv_title">Account Receivable Summary Report
                        ...
                        <div class="table-responsive">
                            <asp:GridView ID="gvList" runat="server" AllowPaging="True" AutoGenerateColumns="False" OnPageIndexChanging="gvList_PageIndexChanging"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="NoOfInv" HeaderText="No Of  Invoice" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="Center" />
                                    <asp:BoundField DataField="ThirtyDays" HeaderText="Thirty Days" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="Center" /> 
                                    <asp:BoundField DataField="SixtyDays" HeaderText="Sixty Days" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="Center" />
                                    <asp:BoundField DataField="NintyDays" HeaderText="Ninty Days" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="Center" />
                                    <asp:BoundField DataField="AboveNintyDays" HeaderText="Above Ninty Days" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="Center" />
                    ...
                    <asp:View ID="Entry" runat="server">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h2 class="mp_ctrl_gv_title">Account Receivable Detail Report
                                 <span class="pull-right">
                        ...
                        <div class="table-responsive">
                            <asp:GridView ID="gvdtl" runat="server" AllowPaging="false" AutoGenerateColumns="False"    OnPageIndexChanging="gvdtl_PageIndexChanging"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="MCust_Code" HeaderText="Vendor Code" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" />
                                    
                                    <asp:BoundField DataField="MCust_Name" HeaderText="Vendor Name" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" />
                                    <asp:BoundField DataField="SINV_No" HeaderText="Invoice No" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="Center" />
                                    <asp:BoundField DataField="vSINV_DT" HeaderText="Invoice Date" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="Center" />
