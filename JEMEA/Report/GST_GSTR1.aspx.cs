...
using MaheshV17.Application;
using MaheshV17.Utility;
using MaheshV17.UIControlHelper.UILayout;
...
{
    public partial class GST_GSTR1 : Mahesh_Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                MaheshV17.UIControlHelper.GenricControl.GetOperatorList(ddOperator);
                MaheshV17.UIControlHelper.GenricControl.GetFieldListByGrid(gvList, ddSearchBy);
                MaheshV17.UIControlHelper.GenricControl.GetOperatorList(Dtl_ddOperator);
                MaheshV17.UIControlHelper.GenricControl.GetFieldListByGrid(gvdtl, Dtl_ddSearchBy);                
