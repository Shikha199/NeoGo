<%@ Page Title="" Language="C#" MasterPageFile="~/AI/LayoutEnterprise/MPEA.Master" AutoEventWireup="true"
    CodeBehind="CustDCN.aspx.cs" Inherits="JEMEA.Sales.CustDCN" %>
            ...
            <div class="container-fluid">
                <div class="mp_ctrl_breadcrumb row clearfix">
                    <div class="breadcrumb-line">
                        <ul class="breadcrumb">
                            <li>Sales</li>
                            <li class="active">Debit/Credit Note Details</li>
                        </ul>
                    </div>
                </div>
                <div class="row mp_ctrl_ph">
                    <div class="col-md-6">
                        <h2 class="mp_ctrl_frmheading">Debit/Credit Note Details</h2>
                    </div>
                    <div class="col-md-6">
                    ...
                    <asp:View ID="List" runat="server">
                        ...
                        <div class="table-responsive">
                            <asp:GridView ID="gvList" runat="server" AllowPaging="True" AutoGenerateColumns="False" OnPageIndexChanging="gvList_PageIndexChanging"
                                ...
                                <Columns>
                                    <asp:BoundField DataField="DCNCHDR_ID" />
                                    <%--<0>--%><asp:TemplateField HeaderText="Sr No" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="50">
                                        <ItemTemplate>
                                            <asp:Label ID="SrNo" runat="server" Text='<%# Container.DataItemIndex + 1 %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="DCNC_Type" HeaderText="Type" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" />
                                    <asp:BoundField DataField="DCNC_No" HeaderText="Ref No" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" />
                                    <asp:BoundField DataField="vDCNC_DT" HeaderText="Entry Dt" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                                    ...
                                    <asp:BoundField DataField="SINV_No" HeaderText="Invoice No" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" />
                                     <asp:BoundField DataField="vSINV_DT" HeaderText="Invoice DT" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" />
                                    
                                      <asp:BoundField DataField="DCNC_DTL_CNT" HeaderText="No Of Item" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="Center" />
                                     
                                     
                                    
                                     
                                    <asp:BoundField DataField="DCNC_HDR_Total_Gross_Amt" HeaderText="Amount" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="Center" />
                        ...
                        <div class="table-responsive">
                            <asp:GridView ID="gvList_Inv" runat="server" AllowPaging="True" AutoGenerateColumns="False" OnPageIndexChanging="gvList_Inv_PageIndexChanging"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="SINV_DueDT" HeaderText="Dute Dt" ItemStyle-HorizontalAlign="center" HeaderStyle-HorizontalAlign="Center" />
                                     
                                     
                                    <asp:BoundField DataField="SINV_HDR_Net_Amt" HeaderText="Net Total" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="Center" />
                    ...
                    <asp:View ID="Entry" runat="server">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <asp:TextBox ID="DCNC_No" ReadOnly="true" CssClass="form-control" ToolTip="Item Code" runat="server" />
                                                        </div>
                                                ...
                                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <asp:TextBox ID="DCNC_DT" CssClass="form-control" ToolTip="Item Code" runat="server" />
                                                            <asp:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="DCNC_DT"
                                                                CssClass="cal_Theme1" Format="dd-MMM-yyyy"></asp:CalendarExtender>
                                                 ...
                                                 <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                       <div class="form-group">
                                                        ...
                                                        <div class="col-md-10">
                                                           <asp:TextBox ID="MCust_Name" ReadOnly="true" CssClass="form-control" ToolTip="Item Code" runat="server" />
                                                        </div>
                                                    </div>
                                                     </div> 
                                                   <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                ...
                                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <asp:TextBox ID="vSINV_DT" ReadOnly="true" CssClass="form-control" ToolTip="Item Code" runat="server" />
                                                  ...
                                                  <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                     <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                           <asp:TextBox ID="DCNC_Type" CssClass="form-control" ToolTip="Item Code" runat="server" ReadOnly="true" />
                                                 ...
                                                 <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <asp:DropDownList ID="DCNC_ShippTo_State_ID" CssClass="form-control mp_ctrl_js_dd" ToolTip="Status" DataValueField="Value"
                                                 ...
                                                 <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                     <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                           <asp:TextBox ID="DCNC_Remark" CssClass="form-control " TextMode="MultiLine" Rows="3" ToolTip="Item Code" runat="server" />
                                                  ...
                                                  <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                     <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                                 ...
                                                                 <asp:DropDownList ID="DCNC_Reason" CssClass="form-control mp_ctrl_js_dd" ToolTip="Status" DataValueField="Value"
                                                                DataTextField="Text" runat="server">
                                                            </asp:DropDownList>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                              ...
                                              <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <asp:TextBox ID="DCNC_HSNCode" CssClass="form-control " MaxLength="10" ToolTip="Item Code" runat="server"  />
                                                </div>
                                            </div>
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <asp:TextBox ID="DCNC_BasicRate" CssClass="form-control " ToolTip="Item Code" runat="server"  />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8   ">
                                                    <asp:TextBox ID="DCNC_QTY" CssClass="form-control" ToolTip="Item Code" runat="server"  />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <asp:TextBox ID="DCNC_DiscountRate" CssClass="form-control" ToolTip="Item Code" runat="server" />
                                                </div>
                                            </div>
                                              ...
                                              <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <asp:TextBox ID="DCNC_ItemRemark_DTL" CssClass="form-control" ToolTip="Item Code" runat="server"  />
                                                </div>
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mpu_txtCenter">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="DCNCHDR_ID" runat="server" Visible="false" />
                                    <asp:TextBox ID="Fk_INVHDR_ID" runat="server" Visible="false" />
                                    <asp:TextBox ID="DCNCDTL_ID" runat="server" Visible="false" />
                        ...
                        <div class="table-responsive">
                            <asp:GridView ID="gvdtl" runat="server" AllowPaging="false" AutoGenerateColumns="False" OnRowDataBound="gvdtl_RowDataBound"
                                ...
                                <Columns>
                                    <asp:BoundField DataField="DCNCDTL_ID" />
                                    <asp:BoundField DataField="Fk_DCNCHDR_ID" />
                                    ...
                                    <asp:BoundField DataField="DCNC_HSNCode" HeaderText="HSN/SAC" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" />
                                    <asp:BoundField DataField="DCNC_QTY" HeaderText="Qty" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="Center" />
                                    <asp:BoundField DataField="DCNC_BasicRate" HeaderText="Unit Rate" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="Center" />
                                    <asp:BoundField DataField="DCNC_BasicAmt" HeaderText="Amount" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="Center" /> 
                                    <asp:BoundField DataField="DCNC_DiscountRate" HeaderText="Discount Rate" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="Center" />
                                    <asp:BoundField DataField="DCNC_DiscountAmt" HeaderText="Discount Amt" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="Center" />

                                    <asp:BoundField DataField="DCNC_NetTaxableAmt" HeaderText="Taxable Amt" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="Center" />
                                    
                                    <asp:BoundField DataField="DCNC_CGST_Tax_DisplayName" HeaderText="CGST" ItemStyle-HorizontalAlign="left" HeaderStyle-HorizontalAlign="Center" />
                                    <asp:BoundField DataField="DCNC_CGST_Amt" HeaderText="CGST Amt" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="Center" />
                                 
                                    <asp:BoundField DataField="DCNC_SGST_Tax_DisplayName" HeaderText="SGST" ItemStyle-HorizontalAlign="left" HeaderStyle-HorizontalAlign="Center" />
                                    <asp:BoundField DataField="DCNC_SGST_Amt" HeaderText="SGST Amt" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="Center" />
                                 

                                     <asp:BoundField DataField="DCNC_IGST_Tax_DisplayName" HeaderText="IGST" ItemStyle-HorizontalAlign="left" HeaderStyle-HorizontalAlign="Center" />
                                     <asp:BoundField DataField="DCNC_IGST_Amt" HeaderText="IGST Amt" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="Center" />
                                 

                                     <asp:BoundField DataField="DCNC_CESS_Tax_DisplayName" HeaderText="CESS" ItemStyle-HorizontalAlign="left" HeaderStyle-HorizontalAlign="Center" />
                                     <asp:BoundField DataField="DCNC_CESS_Amt" HeaderText="CESS Amt" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="Center" /> 
                                       <asp:BoundField DataField="DCNC_TotalTax" HeaderText="Total Tax" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="Center" />

                                    <asp:BoundField DataField="DCNC_GrossRateWithTax" HeaderText="Item Total" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="Center" />
                                     
                                    <asp:BoundField DataField="DCNC_ItemRemark_DTL" HeaderText="Remark" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" />
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    <asp:TextBox ID="DCNC_HDR_BasicAmt" CssClass="form-control" ToolTip="Item Code" runat="server" ReadOnly="true" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <asp:TextBox ID="DCNC_HDR_DiscountAmt" CssClass="form-control " ToolTip="Item Code" runat="server" ReadOnly="true" />
                                                </div>
                                            </div>
                                              <div class="form-group">
                                                <label class="col-sm-7 control-label">Taxable Amt</label>
                                                <div class="col-md-5">
                                                    <asp:TextBox ID="DCNC_HDR_Net_Amt" CssClass="form-control" ToolTip="Item Code" runat="server" ReadOnly="true" />
                                                </div>
                                            </div>
                                             ...
                                             <div class="form-group" style="display:none;">
                                                ...
                                                <div class="col-md-5">
                                                    <asp:TextBox ID="DCNC_HDR_Freight_Charges" CssClass="form-control" ToolTip="Item Code" runat="server" ReadOnly="true" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group" id="Div_CGST_HDR" runat="server">
                                                ...
                                                <div class="col-md-5   ">
                                                    <asp:TextBox ID="DCNC_HDR_CGST_Amt" CssClass="form-control" ToolTip="Item Code" runat="server" ReadOnly="true" />
                                            ...
                                            <div class="form-group" id="Div_SGST_HDR" runat="server">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <asp:TextBox ID="DCNC_HDR_SGST_Amt" ReadOnly="true" CssClass="form-control" ToolTip="Item Code" runat="server" />
                                                </div>
                                            </div>
                                            <div class="form-group"  id="Div_IGST_HDR" runat="server">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <asp:TextBox ID="DCNC_HDR_IGST_Amt" ReadOnly="true" CssClass="form-control" ToolTip="Item Code" runat="server" />
                                                </div>
                                            </div>
                                              <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <asp:TextBox ID="DCNC_HDR_CESS_Amt" ReadOnly="true" CssClass="form-control" ToolTip="Item Code" runat="server" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-7 control-label">Total GST</label>
                                                <div class="col-md-5">
                                                    <asp:TextBox ID="DCNC_HDR_Total_Tax_Amt" CssClass="form-control" ToolTip="Item Code" runat="server" ReadOnly="true" />
                                                </div>
                                            </div>
                                              ...
                                              <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    <asp:TextBox ID="DCNC_HDR_Gross_Amt" CssClass="form-control" ToolTip="Item Code" runat="server" ReadOnly="true" />
                                                </div>
                                            </div>
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    <asp:TextBox ID="DCNC_HDR_Round_Off_Amt" CssClass="form-control" ToolTip="Item Code" runat="server" ReadOnly="true" />
                                                </div>
                                            </div>
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    <asp:TextBox ID="DCNC_HDR_Total_Gross_Amt" CssClass="form-control" ToolTip="Item Code" runat="server" ReadOnly="true" />
                                                </div>
                                            </div>
                                        </div>
