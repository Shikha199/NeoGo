<%@ Page Title="" Language="C#" MasterPageFile="~/AI/LayoutEnterprise/MPEA.Master" AutoEventWireup="true"
    CodeBehind="AccPayable.aspx.cs" Inherits="JEMEA.Purchase.AccPayable" %>
        ...
        <ContentTemplate>
            ...
            <div class="container-fluid">
                ...
                <div class="row mp_ctrl_ph">
                    <div class="col-md-6">
                        <h2 class="mp_ctrl_frmheading">Account Payable</h2>
                    </div>
                    <div class="col-md-6">
                ...
                <asp:MultiView ID="MultiView1" runat="server">
                    <asp:View ID="List" runat="server">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h2 class="mp_ctrl_gv_title">Account Payable Summary Report
                        ...
                        <div class="table-responsive">
                            <asp:GridView ID="gvList" runat="server" AllowPaging="True" AutoGenerateColumns="False" OnPageIndexChanging="gvList_PageIndexChanging"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Fk_VendorID" />
                    ...
                    <asp:View ID="Entry" runat="server">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h2 class="mp_ctrl_gv_title">Account Payable Detail Report
                                 <span class="pull-right">
                        ...
                        <div class="table-responsive">
                            <asp:GridView ID="gvdtl" runat="server" AllowPaging="false" AutoGenerateColumns="False"    OnPageIndexChanging="gvdtl_PageIndexChanging"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="MVen_Name" HeaderText="Vendor Name" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" />
                                    <asp:BoundField DataField="PINV_No" HeaderText="Invoice No" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="Center" />
                                    <asp:BoundField DataField="vPINV_DT" HeaderText="Invoice Date" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="Center" />
