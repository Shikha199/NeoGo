<%@ Page Title="" Language="C#" MasterPageFile="~/AI/LayoutEnterprise/MPEA.Master" AutoEventWireup="true"
    CodeBehind="PurchaseReg.aspx.cs" Inherits="JEMEA.Purchase.PurchaseReg" %>
        ...
        <ContentTemplate>--%>
            ...
            <div class="container-fluid">
                ...
                <div class="row mp_ctrl_ph">
                    <div class="col-md-6">
                        <h2 class="mp_ctrl_frmheading">Purchase Register</h2>
                    </div>
                    <div class="col-md-6">
                ...
                <asp:MultiView ID="MultiView1" runat="server">
                    <asp:View ID="List" runat="server">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h2 class="mp_ctrl_gv_title">Purchase Summary Report

                                 <span class="pull-right">
                                     <asp:Button ID="btnExportToExcelRpt" runat="server" CssClass="btn btn-primary" Text="Download Report" OnClick="btnExportToExcelRpt_Click" />
                    ...
                    <asp:View ID="Entry" runat="server">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h2 class="mp_ctrl_gv_title">Purchase Detail Report
                                 <span class="pull-right">
                                     <asp:Button ID="btnExportDetailToExcelRpt" runat="server" CssClass="btn btn-primary" Text="Download Report" OnClick="btnExportDetailToExcelRpt_Click" />
                     ...
                     <asp:GridView ID="gvSummary_Export" runat="server" AllowPaging="false" AutoGenerateColumns="False"
                         Width="100%">
                         <Columns>
                               <%--<0>--%><asp:TemplateField HeaderText="Sr No" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="50">
                                        <ItemTemplate>
                            ...
                            <asp:GridView ID="gvDetail_Export" runat="server" AllowPaging="false" AutoGenerateColumns="False"
                         Width="100%">
                         <Columns>
                               <asp:TemplateField HeaderText="Sr No" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="50">
                                        <ItemTemplate>
