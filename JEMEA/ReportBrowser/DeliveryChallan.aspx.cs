    ...
    public partial class DeliveryChallan : Mahesh_Page
    {
        ...
        public void GetReport()
        {
            try
            {
                ...
                {
                    sReportInFile = "GST_I_Invoice.rpt";
                }
                else
                {
                    sReportInFile = "DC_SU_CHALLAN.rpt";

                }

                strSQL = " AAA_M_USP_Print_Delivery " + SessionUserData.Company.CompanyID +
                ...
                decimal vatTotalAmt = Convert.ToDecimal(0 + myDS.Rows[0]["DC_HDR_Total_Gross_Amt"].ToString());
                ...
                myReportDocument.ExportToHttpResponse(ExportFormatType.PortableDocFormat, System.Web.HttpContext.Current.Response, false, "Delivery");
