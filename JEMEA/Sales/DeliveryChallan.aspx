<%@ Page Title="" Language="C#" MasterPageFile="~/AI/LayoutEnterprise/MPEA.Master" AutoEventWireup="true"
    CodeBehind="DeliveryChallan.aspx.cs" Inherits="JEMEA.Sales.DeliveryChallan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MAPPMAINCONTENT" runat="server">
        ...
        <ContentTemplate>
            ...
            <div class="container-fluid">
                ...
                <div class="row mp_ctrl_ph">
                    <div class="col-md-6">
                        <h2 class="mp_ctrl_frmheading">Delivery Challan</h2>
                    </div>
                    <div class="col-md-6">
 ...
 <asp:BoundField DataField="DC_DTL_CNT" HeaderText="No Of Item" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="Center" />
                                    
                                      <asp:BoundField DataField="DC_HDR_Total_Gross_Amt" HeaderText="DC Value " ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="Center" />
                            ...
                            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Delivery Challan Details</h3>
                                    </div>
                                        ...
                                        <div class="form-horizontal">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-sm-4 control-label">DC No</label>
                                                        <div class="col-md-8">
                                                            <asp:TextBox ID="DC_No" ReadOnly="true" CssClass="form-control" ToolTip="Item Code" runat="server" />
                                                        </div>
                                                ...
                                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                    <div class="form-group">
                                                        <label class="col-sm-4 control-label">DC Date</label>
                                                        <div class="col-md-4">

                                                            <asp:TextBox ID="DC_DT" CssClass="form-control" ToolTip="Item Code" runat="server" />
                                                            <asp:CalendarExtender ID="CE_DC_DT" runat="server" TargetControlID="DC_DT"
                                                                CssClass="cal_Theme1" Format="dd-MMM-yyyy"></asp:CalendarExtender>
                                                ...
                                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <asp:DropDownList ID="DC_ShippTo_State_ID" CssClass="form-control mp_ctrl_js_dd" ToolTip="Status" DataValueField="Value"
                                                   ...
                                                   <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <asp:DropDownList ID="DC_ShippedFrom_State_ID" CssClass="form-control mp_ctrl_js_dd" ToolTip="Status" DataValueField="Value"
                                                           AutoPostBack="true" OnSelectedIndexChanged="SalesState_SelectedIndexChanged"      DataTextField="Text" runat="server">
                                                            </asp:DropDownList>
                                                ...
                                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <asp:TextBox ID="DC_Remark" CssClass="form-control " TextMode="MultiLine" Rows="3" ToolTip="Item Code" runat="server" />
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <asp:TextBox ID="DC_HSNCode" ReadOnly="true" CssClass="form-control " MaxLength="8" ToolTip="Item Code" runat="server" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <asp:TextBox ID="DC_BasicRate" CssClass="form-control " ToolTip="Item Code" runat="server" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8   ">
                                                    <asp:TextBox ID="DC_QTY" CssClass="form-control" ToolTip="Item Code" runat="server" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <asp:TextBox ID="DC_DiscountRate" CssClass="form-control" ToolTip="Item Code" runat="server" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <asp:TextBox ID="DC_ItemRemark_DTL" CssClass="form-control" ToolTip="Item Code" runat="server" />
                                                </div>
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mpu_txtCenter">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="DCHDR_ID" runat="server" Visible="false" />
                                    <asp:TextBox ID="DCDTL_ID" runat="server" Visible="false" />
                        ...
                        <div class="table-responsive">
                            <asp:GridView ID="gvdtl" runat="server" AllowPaging="false" AutoGenerateColumns="False" OnRowDataBound="gvdtl_RowDataBound"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="DC_HSNCode" HeaderText="HSN" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" />
                                    ...
                                    <asp:BoundField DataField="DC_GrossRateWithTax" HeaderText="Item Total" ItemStyle-HorizontalAlign="right" HeaderStyle-HorizontalAlign="Center" />
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 CompactInputBx">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <asp:TextBox ID="DC_ModeOfDispatch" MaxLength="75" ToolTip="File No" CssClass="form-control" runat="server" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 CompactInputBx">
                                                ...
                                                <div class="col-md-6 CompactInputBx">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <asp:TextBox ID="DC_TranspoterName" MaxLength="75" ToolTip="File No" CssClass="form-control" runat="server" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 CompactInputBx">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <asp:TextBox ID="DC_PlaceOfDelivery" MaxLength="75" ToolTip="File No" CssClass="form-control" runat="server" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 CompactInputBx">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <asp:TextBox ID="DC_VehicleNumber" MaxLength="75" ToolTip="File No" CssClass="form-control" runat="server" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row m0">
                                                            ...
                                                            <div class="col-md-8">
                                                                <asp:TextBox ID="DC_BillTo_Add1" ReadOnly="true" CssClass="form-control" ToolTip="Residential Address" runat="server" />

                                                                <asp:TextBox ID="DC_BillTo_Add2" ReadOnly="true" CssClass="form-control" ToolTip="Residential Address" runat="server" />

                                                                <asp:TextBox ID="DC_BillTo_Add3" ReadOnly="true" CssClass="form-control" ToolTip="Residential Address" runat="server" />
                                                        ...
                                                        <div class="row m0">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox ID="DC_BillTo_Pincode" ReadOnly="true" CssClass="form-control" ToolTip="MobileNo" runat="server" />
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox ID="DC_BillTo_City" ReadOnly="true" CssClass="form-control" ToolTip="MobileNo" runat="server" />
                                                    ...
                                                    <div class="row m0">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <asp:TextBox ID="DC_BillTo_Country" ReadOnly="true" CssClass="form-control" ToolTip="MobileNo" runat="server" />
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <asp:TextBox ID="DC_BillTo_GSTNo" ReadOnly="true" CssClass="form-control" ToolTip="MobileNo" runat="server" />
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <asp:TextBox ID="DC_BillTo_PANNO" ReadOnly="true" CssClass="form-control" ToolTip="MobileNo" runat="server" />
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <div class="row m0">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox ID="DC_ShippTo_CompanyName" CssClass="form-control" ToolTip="MobileNo" runat="server" />
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox ID="DC_ShippTo_ContactPersone" CssClass="form-control" ToolTip="MobileNo" runat="server" />
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox ID="DC_ShippTo_CP_MobileNo" CssClass="form-control" ToolTip="MobileNo" runat="server" />
                                                        ...
                                                        <div class="row m0">
                                                            <label class="col-md-4 control-label">Address</label>
                                                            <div class="col-md-8">
                                                                <asp:TextBox ID="DC_ShippTo_Add1" CssClass="form-control" ToolTip="Residential Address" runat="server" />

                                                                <asp:TextBox ID="DC_ShippTo_Add2" CssClass="form-control" ToolTip="Residential Address" runat="server" />

                                                                <asp:TextBox ID="DC_ShippTo_Add3" CssClass="form-control" ToolTip="Residential Address" runat="server" />
                                                        ...
                                                        <div class="row m0">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <label class="col-md-4 control-label">Pincode</label>
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox ID="DC_ShippTo_Pincode" CssClass="form-control" ToolTip="MobileNo" runat="server" />
                                                    ...
                                                    <div class="row m0">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="col-md-4 control-label">City</label>
                                                                <div class="col-md-8">
                                                                    <asp:TextBox ID="DC_ShippTo_City" CssClass="form-control" ToolTip="MobileNo" runat="server" />
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="col-md-4 control-label">Country</label>
                                                                <div class="col-md-8">
                                                                    <asp:TextBox ID="DC_ShippTo_Country" CssClass="form-control" ToolTip="MobileNo" runat="server" />
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="col-md-4 control-label">GSTIN No</label>
                                                                <div class="col-md-8">
                                                                    <asp:TextBox ID="DC_ShippTo_GSTNo" MaxLength="15" CssClass="form-control" ToolTip="MobileNo" runat="server" />
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="col-md-4 control-label">PAN No</label>
                                                                <div class="col-md-8">
                                                                    <asp:TextBox ID="DC_ShippTo_PANNO" MaxLength="10" CssClass="form-control" ToolTip="MobileNo" runat="server" />
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    <asp:TextBox ID="DC_HDR_BasicAmt" CssClass="form-control" ToolTip="Item Code" runat="server" ReadOnly="true" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <asp:TextBox ID="DC_HDR_DiscountAmt" CssClass="form-control " ToolTip="Item Code" runat="server" ReadOnly="true" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group" style="display: none;">
                                                ...
                                                <div class="col-md-5">
                                                    <asp:TextBox ID="DC_HDR_Freight_Charges" CssClass="form-control" ToolTip="Item Code" runat="server" ReadOnly="true" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    <asp:TextBox ID="DC_HDR_Gross_Amt" CssClass="form-control" ToolTip="Item Code" runat="server" ReadOnly="true" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    <asp:TextBox ID="DC_HDR_Round_Off_Amt" CssClass="form-control" ToolTip="Item Code" runat="server" ReadOnly="true" />
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label class="col-sm-7 control-label">DC Value</label>
                                                <div class="col-md-5">
                                                    <asp:TextBox ID="DC_HDR_Total_Gross_Amt" CssClass="form-control" ToolTip="Item Code" runat="server" ReadOnly="true" />
                                                </div>
                                            </div>
                                        </div>
