...
{
public class M_AT_Proc_JW_BDTLBO
{
    MaheshAF18.DataAccess.IUD ObjDataAcess =new  MaheshAF18.DataAccess.IUD();
#region Constructor 
public M_AT_Proc_JW_BDTLBO() { }
#endregion 
#region Standard Property
private string _PrimaryKeyName = "JW_DTL_ID";
private string _TableName = "M_AT_Proc_JW_BDTL";
...
private Int64 _JW_DTL_ID;
private Int64 _Fk_JW_HDR_ID;
private Int64 _Fk_MItem_ID;
private String _JW_HSNCode;
private Decimal _JW_QTY;
private Decimal _JW_BasicRate;
private Decimal _JW_NetRate;
private Decimal _JW_BasicAmt;
...
public Int64 JW_DTL_ID
{
get
  {
   return this._JW_DTL_ID;  }
set
   {
     this._JW_DTL_ID = value;
     _UpdateFieldName.Add("JW_DTL_ID");
     }
}
public Int64 Fk_JW_HDR_ID
{
get
  {
      return this._Fk_JW_HDR_ID;
  }
set
   {
       this._Fk_JW_HDR_ID = value;
       _UpdateFieldName.Add("Fk_JW_HDR_ID");
     }
}
...
public String JW_HSNCode
{
get
  {
   return this._JW_HSNCode;  }
set
   {
     this._JW_HSNCode = value;
     _UpdateFieldName.Add("JW_HSNCode");
     }
}
public Decimal JW_QTY
{
get
  {
   return this._JW_QTY;  }
set
   {
     this._JW_QTY = value;
     _UpdateFieldName.Add("JW_QTY");
     }
}
public Decimal JW_BasicRate
{
get
  {
   return this._JW_BasicRate;  }
set
   {
     this._JW_BasicRate = value;
     _UpdateFieldName.Add("JW_BasicRate");
     }
}
...
public Decimal JW_BasicAmt
{
get
  {
   return this._JW_BasicAmt;  }
set
   {
     this._JW_BasicAmt = value;
     _UpdateFieldName.Add("JW_BasicAmt");
     }
}
...
public string Insert_Update(M_AT_Proc_JW_BDTLBO sObject)
{
   try
    {
         string strPkValue="";
...
// ObjAT_JWDTL.JW_DTL_ID=ObjAT_JWDTL.JW_DTL_ID;
// ObjAT_JWDTL.JW_HDR_ID=ObjAT_JWDTL.JW_HDR_ID;
// ObjAT_JWDTL.Fk_MItem_ID=ObjAT_JWDTL.Fk_MItem_ID;
// ObjAT_JWDTL.JW_HSNCode=ObjAT_JWDTL.JW_HSNCode;
// ObjAT_JWDTL.JW_QTY=ObjAT_JWDTL.JW_QTY;
// ObjAT_JWDTL.JW_BasicRate=ObjAT_JWDTL.JW_BasicRate;
// ObjAT_JWDTL.JW_NetRate=ObjAT_JWDTL.JW_NetRate;
// ObjAT_JWDTL.JW_BasicAmt=ObjAT_JWDTL.JW_BasicAmt;
...
// ObjAT_JWDTL.JW_DTL_ID=JW_DTL_ID.Text ;
// ObjAT_JWDTL.JW_HDR_ID=JW_HDR_ID.Text ;
// ObjAT_JWDTL.Fk_MItem_ID=Fk_MItem_ID.Text ;
// ObjAT_JWDTL.JW_HSNCode=JW_HSNCode.Text ;
// ObjAT_JWDTL.JW_QTY=JW_QTY.Text ;
// ObjAT_JWDTL.JW_BasicRate=JW_BasicRate.Text ;
// ObjAT_JWDTL.JW_NetRate=JW_NetRate.Text ;
// ObjAT_JWDTL.JW_BasicAmt=JW_BasicAmt.Text ;
...
// JW_BasicAmt.Text =  dt.Rows[0]["JW_BasicAmt"].ToString();
