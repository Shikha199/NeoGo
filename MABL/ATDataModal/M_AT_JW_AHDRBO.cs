...
{
public class M_AT_JW_AHDRBO
{
    MaheshAF18.DataAccess.IUD ObjDataAcess = new MaheshAF18.DataAccess.IUD();
#region Constructor 
public M_AT_JW_AHDRBO() { }
#endregion 
#region Standard Property
private string _PrimaryKeyName = "JWHDR_ID";
private string _TableName = "M_AT_JW_AHDR";
...
private String _JW_Taxtype;
private String _JW_No;
private String _JW_DT;
private Int64 _Fk_VendorID;
private Int16 _JW_CreditDays;
private String _JW_DueDT;
private Int64 _JW_State_ID;
private String _JW_BillTo_CompanyName;
private String _JW_BillTo_ContactPersone;
private String _JW_BillTo_CP_MobileNo;
private String _JW_BillTo_Add1;
private String _JW_BillTo_Add2;
private String _JW_BillTo_Add3;
private String _JW_BillTo_Pincode;
private String _JW_BillTo_Area;
private String _JW_BillTo_City;
private Int64 _JW_BillTo_State_ID;
private String _JW_BillTo_Country;
private String _JW_BillTo_GSTNo;
private String _JW_BillTo_PANNO;
...
public Int64 JWHDR_ID
{
get
  {
   return this._JWHDR_ID;  }
set
   {
     this._JWHDR_ID = value;
     _UpdateFieldName.Add("JWHDR_ID");
     }
}
...
public String JW_Taxtype
{
get
  {
   return this._JW_Taxtype;  }
set
   {
     this._JW_Taxtype = value;
     _UpdateFieldName.Add("JW_Taxtype");
     }
}
public String JW_No
{
...
public Int16 JW_CreditDays
{
get
  {
   return this._JW_CreditDays;  }
set
   {
     this._JW_CreditDays = value;
     _UpdateFieldName.Add("JW_CreditDays");
     }
}
...
public String JW_BillTo_CompanyName
{
get
  {
   return this._JW_BillTo_CompanyName;  }
set
   {
     this._JW_BillTo_CompanyName = value;
     _UpdateFieldName.Add("JW_BillTo_CompanyName");
     }
}
public String JW_BillTo_ContactPersone
{
get
  {
   return this._JW_BillTo_ContactPersone;  }
set
   {
     this._JW_BillTo_ContactPersone = value;
     _UpdateFieldName.Add("JW_BillTo_ContactPersone");
     }
}
public String JW_BillTo_CP_MobileNo
{
get
  {
   return this._JW_BillTo_CP_MobileNo;  }
set
   {
     this._JW_BillTo_CP_MobileNo = value;
     _UpdateFieldName.Add("JW_BillTo_CP_MobileNo");
     }
}
public String JW_BillTo_Add1
{
get
  {
   return this._JW_BillTo_Add1;  }
set
   {
     this._JW_BillTo_Add1 = value;
     _UpdateFieldName.Add("JW_BillTo_Add1");
     }
}
public String JW_BillTo_Add2
{
get
  {
   return this._JW_BillTo_Add2;  }
set
   {
     this._JW_BillTo_Add2 = value;
     _UpdateFieldName.Add("JW_BillTo_Add2");
     }
}
public String JW_BillTo_Add3
{
get
  {
   return this._JW_BillTo_Add3;  }
set
   {
     this._JW_BillTo_Add3 = value;
     _UpdateFieldName.Add("JW_BillTo_Add3");
     }
}
public String JW_BillTo_Pincode
{
get
  {
   return this._JW_BillTo_Pincode;  }
set
   {
     this._JW_BillTo_Pincode = value;
     _UpdateFieldName.Add("JW_BillTo_Pincode");
     }
}
public String JW_BillTo_Area
{
get
  {
   return this._JW_BillTo_Area;  }
set
   {
     this._JW_BillTo_Area = value;
     _UpdateFieldName.Add("JW_BillTo_Area");
     }
}
public String JW_BillTo_City
{
get
  {
   return this._JW_BillTo_City;  }
set
   {
     this._JW_BillTo_City = value;
     _UpdateFieldName.Add("JW_BillTo_City");
     }
}
public Int64 JW_BillTo_State_ID
{
get
  {
   return this._JW_BillTo_State_ID;  }
set
   {
     this._JW_BillTo_State_ID = value;
     _UpdateFieldName.Add("JW_BillTo_State_ID");
     }
}
public String JW_BillTo_Country
{
get
  {
   return this._JW_BillTo_Country;  }
set
   {
     this._JW_BillTo_Country = value;
     _UpdateFieldName.Add("JW_BillTo_Country");
     }
}
public String JW_BillTo_GSTNo
{
get
  {
   return this._JW_BillTo_GSTNo;  }
set
   {
     this._JW_BillTo_GSTNo = value;
     _UpdateFieldName.Add("JW_BillTo_GSTNo");
     }
}
public String JW_BillTo_PANNO
{
get
  {
   return this._JW_BillTo_PANNO;  }
set
   {
     this._JW_BillTo_PANNO = value;
     _UpdateFieldName.Add("JW_BillTo_PANNO");
     }
}
...
public String JW_ExciseDuty
{
get
  {
   return this._JW_ExciseDuty;  }
set
   {
     this._JW_ExciseDuty = value;
     _UpdateFieldName.Add("JW_ExciseDuty");
     }
}
...
public String JW_LRNumber
{
get
  {
   return this._JW_LRNumber;  }
set
   {
     this._JW_LRNumber = value;
     _UpdateFieldName.Add("JW_LRNumber");
     }
}
...
public string Insert_Update(M_AT_JW_AHDRBO sObject)
{
   try
    {
         string strPkValue="";
...
// ObjAT_JWHDR.JWHDR_ID=ObjAT_JWHDR.JWHDR_ID;
...
// ObjAT_JWHDR.JW_Taxtype=ObjAT_JWHDR.JW_Taxtype;
// ObjAT_JWHDR.JW_No=ObjAT_JWHDR.JW_No;
// ObjAT_JWHDR.JW_DT=ObjAT_JWHDR.JW_DT;
// ObjAT_JWHDR.Fk_VendorID=ObjAT_JWHDR.Fk_VendorID;
// ObjAT_JWHDR.JW_CreditDays=ObjAT_JWHDR.JW_CreditDays;
// ObjAT_JWHDR.JW_DueDT=ObjAT_JWHDR.JW_DueDT;
// ObjAT_JWHDR.JW_State_ID=ObjAT_JWHDR.JW_State_ID;
// ObjAT_JWHDR.JW_BillTo_CompanyName=ObjAT_JWHDR.JW_BillTo_CompanyName;
// ObjAT_JWHDR.JW_BillTo_ContactPersone=ObjAT_JWHDR.JW_BillTo_ContactPersone;
// ObjAT_JWHDR.JW_BillTo_CP_MobileNo=ObjAT_JWHDR.JW_BillTo_CP_MobileNo;
// ObjAT_JWHDR.JW_BillTo_Add1=ObjAT_JWHDR.JW_BillTo_Add1;
// ObjAT_JWHDR.JW_BillTo_Add2=ObjAT_JWHDR.JW_BillTo_Add2;
// ObjAT_JWHDR.JW_BillTo_Add3=ObjAT_JWHDR.JW_BillTo_Add3;
// ObjAT_JWHDR.JW_BillTo_Pincode=ObjAT_JWHDR.JW_BillTo_Pincode;
// ObjAT_JWHDR.JW_BillTo_Area=ObjAT_JWHDR.JW_BillTo_Area;
// ObjAT_JWHDR.JW_BillTo_City=ObjAT_JWHDR.JW_BillTo_City;
// ObjAT_JWHDR.JW_BillTo_State_ID=ObjAT_JWHDR.JW_BillTo_State_ID;
// ObjAT_JWHDR.JW_BillTo_Country=ObjAT_JWHDR.JW_BillTo_Country;
// ObjAT_JWHDR.JW_BillTo_GSTNo=ObjAT_JWHDR.JW_BillTo_GSTNo;
// ObjAT_JWHDR.JW_BillTo_PANNO=ObjAT_JWHDR.JW_BillTo_PANNO;
...
// ObjAT_JWHDR.JW_ExciseDuty=ObjAT_JWHDR.JW_ExciseDuty;
...
// ObjAT_JWHDR.JW_LRNumber=ObjAT_JWHDR.JW_LRNumber;
...
// JW_DueDT.Text = "";
// JW_State_ID.Text = "";
// JW_BillTo_CompanyName.Text = "";
// JW_BillTo_ContactPersone.Text = "";
// JW_BillTo_CP_MobileNo.Text = "";
// JW_BillTo_Add1.Text = "";
// JW_BillTo_Add2.Text = "";
// JW_BillTo_Add3.Text = "";
...
// ObjAT_JWHDR.JWHDR_ID=JWHDR_ID.Text ;
...
// ObjAT_JWHDR.JW_Taxtype=JW_Taxtype.Text ;
// ObjAT_JWHDR.JW_No=JW_No.Text ;
// ObjAT_JWHDR.JW_DT=JW_DT.Text ;
// ObjAT_JWHDR.Fk_VendorID=Fk_VendorID.Text ;
// ObjAT_JWHDR.JW_CreditDays=JW_CreditDays.Text ;
// ObjAT_JWHDR.JW_DueDT=JW_DueDT.Text ;
// ObjAT_JWHDR.JW_State_ID=JW_State_ID.Text ;
// ObjAT_JWHDR.JW_BillTo_CompanyName=JW_BillTo_CompanyName.Text ;
// ObjAT_JWHDR.JW_BillTo_ContactPersone=JW_BillTo_ContactPersone.Text ;
// ObjAT_JWHDR.JW_BillTo_CP_MobileNo=JW_BillTo_CP_MobileNo.Text ;
// ObjAT_JWHDR.JW_BillTo_Add1=JW_BillTo_Add1.Text ;
// ObjAT_JWHDR.JW_BillTo_Add2=JW_BillTo_Add2.Text ;
// ObjAT_JWHDR.JW_BillTo_Add3=JW_BillTo_Add3.Text ;
// ObjAT_JWHDR.JW_BillTo_Pincode=JW_BillTo_Pincode.Text ;
// ObjAT_JWHDR.JW_BillTo_Area=JW_BillTo_Area.Text ;
// ObjAT_JWHDR.JW_BillTo_City=JW_BillTo_City.Text ;
// ObjAT_JWHDR.JW_BillTo_State_ID=JW_BillTo_State_ID.Text ;
// ObjAT_JWHDR.JW_BillTo_Country=JW_BillTo_Country.Text ;
// ObjAT_JWHDR.JW_BillTo_GSTNo=JW_BillTo_GSTNo.Text ;
// ObjAT_JWHDR.JW_BillTo_PANNO=JW_BillTo_PANNO.Text ;
...
// ObjAT_JWHDR.JW_ExciseDuty=JW_ExciseDuty.Text ;
...
// ObjAT_JWHDR.JW_LRNumber=JW_LRNumber.Text ;
...
// JWHDR_ID.Text =  dt.Rows[0]["JWHDR_ID"].ToString();
...
// JW_Taxtype.Text =  dt.Rows[0]["JW_Taxtype"].ToString();
// JW_No.Text =  dt.Rows[0]["JW_No"].ToString();
// JW_DT.Text =  dt.Rows[0]["JW_DT"].ToString();
// Fk_VendorID.Text =  dt.Rows[0]["Fk_VendorID"].ToString();
// JW_CreditDays.Text =  dt.Rows[0]["JW_CreditDays"].ToString();
// JW_DueDT.Text =  dt.Rows[0]["JW_DueDT"].ToString();
// JW_State_ID.Text =  dt.Rows[0]["JW_State_ID"].ToString();
// JW_BillTo_CompanyName.Text =  dt.Rows[0]["JW_BillTo_CompanyName"].ToString();
// JW_BillTo_ContactPersone.Text =  dt.Rows[0]["JW_BillTo_ContactPersone"].ToString();
// JW_BillTo_CP_MobileNo.Text =  dt.Rows[0]["JW_BillTo_CP_MobileNo"].ToString();
// JW_BillTo_Add1.Text =  dt.Rows[0]["JW_BillTo_Add1"].ToString();
// JW_BillTo_Add2.Text =  dt.Rows[0]["JW_BillTo_Add2"].ToString();
// JW_BillTo_Add3.Text =  dt.Rows[0]["JW_BillTo_Add3"].ToString();
// JW_BillTo_Pincode.Text =  dt.Rows[0]["JW_BillTo_Pincode"].ToString();
// JW_BillTo_Area.Text =  dt.Rows[0]["JW_BillTo_Area"].ToString();
// JW_BillTo_City.Text =  dt.Rows[0]["JW_BillTo_City"].ToString();
// JW_BillTo_State_ID.Text =  dt.Rows[0]["JW_BillTo_State_ID"].ToString();
// JW_BillTo_Country.Text =  dt.Rows[0]["JW_BillTo_Country"].ToString();
// JW_BillTo_GSTNo.Text =  dt.Rows[0]["JW_BillTo_GSTNo"].ToString();
// JW_BillTo_PANNO.Text =  dt.Rows[0]["JW_BillTo_PANNO"].ToString();
...
// JW_ExciseDuty.Text =  dt.Rows[0]["JW_ExciseDuty"].ToString();
...
// JW_LRNumber.Text =  dt.Rows[0]["JW_LRNumber"].ToString();
